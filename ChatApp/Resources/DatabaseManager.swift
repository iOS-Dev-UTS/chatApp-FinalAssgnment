...
extension DatabaseManager {
    ...
    /// Sends a message with target conversation and message
       public func sendMessage(to conversation: String, otherUserEmail: String, name: String, newMessage: Message, completion: @escaping (Bool) -> Void) {
           ...
           let currentEmail = DatabaseManager.validEmail(emailAddress: myEmail)
           ...
           database.child("\(conversation)/messages").observeSingleEvent(of: .value, with: { [weak self] snapshot in
               ...
               let currentUserEmail = DatabaseManager.validEmail(emailAddress: myEmmail)
                   ...
                   strongSelf.database.child("\(currentEmail)/conversations").observeSingleEvent(of: .value, with: { snapshot in
                       ...
                       if var currentUserConversations = snapshot.value as? [[String: Any]] {
                           ...
                           if var targetConversation = targetConversation {
                               ...
                               let newConversationData: [String: Any] = [
                                   "id": conversation,
                                   "other_user_email": DatabaseManager.validEmail(emailAddress: otherUserEmail),
                                   "name": name,
                           ...
                           strongSelf.database.child("\(otherUserEmail)/conversations").observeSingleEvent(of: .value, with: { snapshot in
                               ...
                               if var otherUserConversations = snapshot.value as? [[String: Any]] {
                                   ...
                                   if var targetConversation = targetConversation {
                                       ...
                                       let newConversationData: [String: Any] = [
                                           "id": conversation,
                                           "other_user_email": DatabaseManager.validEmail(emailAddress: currentEmail),
                                           "name": currentName,
                                           "latest_message": updatedValue
                                       ]
